            ...
            <div className={styles.extraWrapper}>
                ...
                <div className={styles.roadmapGrid}>
                    <div className={styles.image}>
                        <Image alt="roadmap illustration" src="/roadmap.png" width="572" height="1050"></Image>
                    </div>
                        ...
                        <div className={styles.path}>
                            <div>
                                ...
                                <ul>
                                    ...
                                    <li>Twitter, YouTube, Discord, Instagram, Reddit,<br/> Telegram, Facebook</li>
                                    <li>Rarity Index</li>
                                    <li>Mint Frens</li>
                                    <li>Secondary marketplace listings</li>
                                    <li>MemeMarketplace, Solanart.io, Alpha.art, <br/> Solsea</li>
